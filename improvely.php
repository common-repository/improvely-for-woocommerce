...
<div class="wrap">
    ...
    <div style="width: 772px; font-size: 15px">		
		...
		<p>
			Improvely for WooCommerce will send information about website visits and purchases on this site
		...
		<div style="background: #eee">
		    ...
		    <table class="form-table" style="margin: 10px">
		        <tr valign="top">
		            <th scope="row" style="white-space: nowrap"><label>Improvely Account Name:</label></th>
		            <td style="width: 100%">
		...
		<div style="background: #eee; margin-top: 10px">
			<div style="background: #ccc; padding: 10px; font-weight: bold">Where do I find my account name and project ID?</div>
			<div style="padding: 10px">
				Your account name is the subdomain you chose when you signed up, and where you 
				log in to access your account.

				<br /><br /> 

				You can retrieve both your account name and project ID from the <b>Get Website Code</b> page 
				in your account. To get there, click "Settings" in the left menu, then "Get Website Code" in the top
				menu.
				...
				<img src="<?php echo plugins_url( 'install.png' , __FILE__ ) ?>" alt="Banner" style="border: 1px solid #ccc" />
